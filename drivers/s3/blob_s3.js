...
S3_blob.prototype.bucket_create = function(bucket_name,data_stream,callback)
{
  var opt = {};
...
S3_blob.prototype.bucket_delete = function(bucket_name,callback)
{
...
S3_blob.prototype.object_create = function(bucket_name,filename,create_options, create_meta_data, data,callback)
{
  var resp_header, resp_code, resp_body;
...
S3_blob.prototype.object_copy = function(bucket_name,object_key,header,header2, callback)
{
  var self = this;
...
S3_blob.prototype.object_delete = function(bucket_name,filename,callback)
{
...
S3_blob.prototype.object_read = function(bucket_name, filename, options, callback)
{
...
S3_blob.prototype.bucket_list = function(callback) {
...
S3_Driver.prototype.bucket_list = function(callback)
{
  if (check_client(this.client,callback) === false) return;
  this.client.bucket_list(callback);
};
...
S3_Driver.prototype.object_list = function(bucket_name,option,callback)
{
  if (check_client(this.client,callback) === false) return;
...
S3_Driver.prototype.object_read = function(bucket_name,object_key,options, callback)
{
  if (check_client(this.client,callback) === false) return;
  this.client.object_read(bucket_name,object_key,options,callback);
};

S3_Driver.prototype.object_create = function(bucket_name,object_key,options,metadata,data_stream,callback)
{
  if (check_client(this.client,callback) === false) return;
  this.client.object_create(bucket_name,object_key, options, metadata, data_stream, callback);
};

S3_Driver.prototype.object_copy = function(bucket_name, object_key, source_bucket,source_object_key,options,metadata,callback)
{
  if (check_client(this.client,callback) === false) return;
  options["x-amz-copy-source"] = "/"+source_bucket+"/"+source_object_key;
  this.client.object_copy(bucket_name,object_key,options,metadata,callback);
};

S3_Driver.prototype.object_delete = function(bucket_name,object_key,callback)
{
  if (check_client(this.client,callback) === false) return;
  this.client.object_delete(bucket_name,object_key,callback);
};


S3_Driver.prototype.bucket_create = function(bucket_name,options,data_stream,callback)
{
  if (check_client(this.client,callback) === false) return;
  this.client.bucket_create(bucket_name,data_stream,callback);
};

S3_Driver.prototype.bucket_delete = function(bucket_name,callback)
{
  if (check_client(this.client,callback) === false) return;
  this.client.bucket_delete(bucket_name,callback);
};
